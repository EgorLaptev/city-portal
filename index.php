...
<body>
  ...
  <div class="container">
    ...
    <div class="wrap">
      <div class="couple">
        <img src="./media/img/decision1.jpg" alt="Яма на дороге">
        <img src="./media/img/problem1.jpg" alt="Яма на дороге">
      </div>
      <div class="couple">
        <img src="./media/img/decision3.jpg" alt="Яма на дороге">
        <img src="./media/img/problem3.jpg" alt="Яма на дороге">
      </div>
      <div class="couple">
        <img src="./media/img/decision4.jpg" alt="Яма на дороге">
        <img src="./media/img/problem4.jpg" alt="Яма на дороге">
      </div>
      <div class="couple">
        <img src="./media/img/decision5.jpg" alt="Яма на дороге">
        <img src="./media/img/problem5.jpg" alt="Яма на дороге">
      </div>
      <div class="couple">
        <img src="./media/img/decision6.jpg" alt="Яма на дороге">
        <img src="./media/img/problem6.jpg" alt="Яма на дороге">
      </div>
      <div class="couple">
        <img src="./media/img/decision1.jpg" alt="Яма на дороге">
        <img src="./media/img/problem1.jpg" alt="Яма на дороге">
